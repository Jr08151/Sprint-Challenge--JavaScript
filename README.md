...
forEach loops over an array and calls what ever function is passed in as it's parameter for every element in the array. map does the same thing except it passes the result of the given function to a new array.
...
A closure is when a child or grandchild function has access to varibles in the parents scope.

4. Describe the four rules of the 'this' keyword.

Global binding - Default context of the "this" key word. also known as window binding.
...
Super is used in an extended class to bind properties from the parent constructor to the new one.
