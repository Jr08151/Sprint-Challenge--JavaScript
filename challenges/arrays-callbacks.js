...
const lowCaseAnimalNames = zooAnimals.map(animal => annimal.animal_name.toLowerCase());
...
*/
const populationTotal = zooAnimals.reduce((animalAccumulator, animal) => animalAccumulator + animal.population, 0);
